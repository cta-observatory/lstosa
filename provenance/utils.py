...
def parse_variables(class_instance):
    ...
    if class_instance.__name__ == "r0_to_dl1":
        ...
        class_instance.ObservationRun = class_instance.args[4].split(".")[0]
        class_instance.ObservationSubRun = class_instance.args[4].split(".")[1]
        # /fefs/aswg/data/real/DL1/20200218/v0.4.3_v00/sequence_LST1_02006.0000.txt
        class_instance.ObservationDate = re.findall(r"DL1/(\d{8})/", class_instance.args[5])[0]
        class_instance.SoftwareVersion = re.findall(r"DL1/\d{8}/(v.*)_v", class_instance.args[5])[0]
        class_instance.ProdID = re.findall(r"DL1/\d{8}/v.*_v(.*)/", class_instance.args[5])[0]
        # /fefs/aswg/data/real/calibration/20200218/v00/calibration.Run2006.0000.hdf5
        ...
        class_instance.R0SubrunDataset = f"{rawdir}/{class_instance.ObservationDate}/LST1.1Run{class_instance.args[4]}{fits}{fz}"
