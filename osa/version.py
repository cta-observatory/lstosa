...
try:
    ...
    warnings.warn(
        "Could not determine lstosa version; this indicates a broken installation."
        " Install lstosa from PyPI, a local git repository or using "
        " pip install git+https://github.com/cta-observatory/lstosa@VERSION "
