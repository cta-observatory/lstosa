...
def is_finished_check(nightsum):
    tag = gettag()
    from raw import arerawfilestransferred
    from extract import extractsubruns, extractruns, extractsequences
    from job import arealljobscorrectlyfinished
